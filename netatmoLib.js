...
netatmo.prototype.clearAccessToken = function (auth, callback) {
...
netatmo.prototype.refreshAccessToken = function (auth, callback) {
    // console.log("refresh....");
    // console.log(access_token);
    // console.log(refresh_token);

    //refresh
    this.authenticate_refresh(refresh_token);
